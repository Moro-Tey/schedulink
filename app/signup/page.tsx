        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 bg-gray-50 border-gray-200 text-gray-700 hover:bg-gray-100 flex items-center justify-center gap-3"
            >
          ...
          <p className="text-center text-gray-600">
            ...
            <Link href="/login" className="text-[#9AA2C5] hover:text-[#8A94B8] font-medium">
              Login here
            </Link>
          </p>
        </form>
